...
- #### 主类：src/main/java/com/program/probie/Tools.java
- #### 方法包1：src/main/java/com/program/probie/ProgrameTool (已完善)
...
- #### Datesql：包含了对数据存储的一些简单操作，满足本地数据和远程数据的存储需求
- #### Math：包含了对数据运算的简单计算，如时间、角度、随机数、字符转义等
- #### Type：包含了一些类型选择器
...
- #### Datesql: contains some simple operations for data storage, meeting the storage requirements of both local and remote data
- #### Math: contains simple calculations for data operations, such as time, Angle, random number, character escape, etc
